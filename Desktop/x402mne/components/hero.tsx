  ...
  return (
    <div className="flex flex-col h-svh justify-between">
      ...
      <div className="pb-16 mt-auto text-center relative">
        <Pill className="mb-6">MNEE Hackathon - Programmable Money Live</Pill>
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-sentient leading-tight">
          Programmable Money <br />
          <i className="font-light">for Agents, Commerce, and Automated Finance</i>
        </h1>
        <p className="font-mono text-xs sm:text-sm md:text-base text-blue-300 text-balance mt-6 sm:mt-8 max-w-[640px] mx-auto px-4 sm:px-0">
          Build the future of digital commerce with MNEE, a USD-backed stablecoin on Ethereum. Enable AI agents to transact autonomously, creators to accept stable payments, and smart contracts to automate financial workflows.
        </p>
