...
export function LiveDemo() {
  ...
  const handleAction = async (action: string) => {
    ...
    setTimeout(() => {
      let agentResponse = "";
      if (action === "Say Hello") {
        agentResponse = "Hello! I'm an autonomous commerce agent. I can help you make purchases using MNEE stablecoin on Ethereum. What would you like to buy?";
      } else if (action === "Buy a Banana") {
        agentResponse = "I'll create an invoice for 1 Banana. Amount: 0.1 MNEE. Please approve the payment to proceed.";
    ...
    <section id="demo" className="py-24 container">
      <div className="text-center mb-16">
        ...
        <p className="font-mono text-xs sm:text-sm text-blue-300 text-balance max-w-2xl mx-auto mb-6 sm:mb-8 px-4 sm:px-0">
          Chat with an agent that can: take orders, generate invoices, ask for payment approval, trigger a real MNEE transaction on Ethereum, verify confirmation, return receipt & explorer link. This is end-to-end programmable money powered by MNEE stablecoin.
        </p>
      </div>
